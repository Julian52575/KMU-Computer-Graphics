...
Globe::Globe() : ARender("Globe"),
	radius(1.0f), slices(32), stacks(16)
{
	this->init();
}

Globe::Globe(float rad, GLuint sl, GLuint st) : ARender("Globe"),
...
void Globe::generateVerts(float * verts, float * norms, float * tex,
	unsigned int * el)
{
...
int Globe::getVertexArrayHandle() 
{
	return this->VAO;
}
